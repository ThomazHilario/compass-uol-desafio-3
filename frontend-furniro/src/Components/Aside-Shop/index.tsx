...
export const AsideShop = () => {
    ...
    // zustand store
    const { showQuantity, setShowQuantity } = filterStore()
    ...
    function changeShowQuantity(value:string){
        ...
        if(regexNumbersInString.test(value as string)){
            ...
            if(quantitySelectedForUser >= min && quantitySelectedForUser <= max){
                setShowQuantity(quantitySelectedForUser)
            } else{
                setShowQuantity(16)
            }
    ...
    return(
        <aside>
           <div id='content-aside'>
                ...
                <section id='product__list__items'>
                    <ul>
                        <li>
                    ...
                    <p>Showing 1–{showQuantity} of {max} results</p>
                </section>
                ...
                <form>
                    ...
                    <div>
                        ...
                        <select name="sortProducts" id="ishort">
