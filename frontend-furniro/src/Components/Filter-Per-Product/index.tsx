// css import
import './filter-per-product.css'

export const FilterPerProduct = () => {

    // Active dialog
    function activeContent(button:EventTarget){
        if(button instanceof HTMLButtonElement){

            // Find div element
            const divElement = button.nextElementSibling as HTMLDivElement

            // Logic for display active
    ...
    return(
        <>
            ...
            <div className='content__filter' id='content__filter__by__product'>
                <form id='filter__by__product'>
